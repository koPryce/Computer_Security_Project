...
public class Success_Window extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Success_Window window = new Success_Window();
	...
	private void initialize() {
		...
		JLabel lblWelcomeXyzManufactoring = new JLabel("WELCOME");
		...
		JButton btnLogIn = new JButton("LOG OUT");
