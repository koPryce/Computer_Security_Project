...
public class Main_Window extends JFrame {
	...
	private void initialize() {
		...
		JLabel lblWelcomeXyzManufactoring = new JLabel("WELCOME TO XYZ MANUFACTORING LTD.");
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addComponent(lblWelcomeXyzManufactoring, GroupLayout.PREFERRED_SIZE, 421, GroupLayout.PREFERRED_SIZE)
					.addGap(106)
